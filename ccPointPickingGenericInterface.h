...
protected:
	...
	**/
	...
	//! Generic method to process picked triangles
    //! Added by yuqiang on 2015/9/24
	/** \param mesh picked mesh
		\param triangleIndex triangle index in mesh
		\param x picked pixel X position
		\param y picked pixel Y position
	**/
    virtual void processPickedTriangle(ccMesh* mesh, unsigned triangleIndex, int x, int y) = 0;
